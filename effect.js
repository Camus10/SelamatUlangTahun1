...
$('document').ready(function(){
  ...
  function loopNineteen(){
	...
	$('#wish_message').click(function(){
		...
		$('#b18').attr('id', 'r');
		$('#b19').attr('id', 's');
		$('#a').animate({top:140, left: vw - 450}, 500);  // S
		$('#b').animate({top:140, left: vw - 350}, 500);  // R
		$('#c').animate({top:140, left: vw - 250}, 500);  // Y
		$('#d').animate({top:140, left: vw + 50}, 500);   // U
		$('#e').animate({top:140, left: vw + 150}, 500);   // L
		$('#f').animate({top:140, left: vw + 250}, 500);  // I
		$('#g').animate({top:140, left: vw + 350}, 500);  // N
		$('#h').animate({top:140, left: vw + 450}, 500);  // A
		$('#i').animate({top:240, left: vw - 550}, 500);  // B
		$('#j').animate({top:240, left: vw - 450}, 500);  // R
		$('#k').animate({top:240, left: vw - 250}, 500);  // S
		$('#l').animate({top:240, left: vw - 150}, 500);  // E
		$('#m').animate({top:240, left: vw - 50}, 500);   // M
		$('#n').animate({top:240, left: vw + 50}, 500);  // B
		$('#o').animate({top:240, left: vw + 150}, 500);  // I
		$('#p').animate({top:240, left: vw + 250}, 500);  // R
		$('#q').animate({top:240, left: vw + 350}, 500);  // I
		$('#r').animate({top:240, left: vw + 450}, 500);  // N
		$('#s').animate({top:240, left: vw + 550}, 500);  // G
